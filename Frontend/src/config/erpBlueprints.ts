    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { type: "link", label: "Propose Event (ERP)", route: "/events/propose-new-event", domain: "campus", access: "A" },
        ],
      },
      {
        type: "link",
...
export const PAGE_BLUEPRINTS: Record<string, PageBlueprint> = {
  ...
  "/events/listings": {
    route: "/events/listings",
    heading: "Events Listings",
    fetchKeys: [],
    domain: "campus",
    integrationState: "placeholder",
    renderer: "generic",
  ...
  "/events/registered-events": {
    route: "/events/registered-events",
  ...
  "/events/propose-new-event": {
    route: "/events/propose-new-event",
    heading: "Propose New Event",
    fetchKeys: [],
    domain: "campus",
    integrationState: "placeholder",
    renderer: "generic",
  ...
  "/events/:eventId/rounds/:roundId/leaderboard": {
    route: "/events/:eventId/rounds/:roundId/leaderboard",
    heading: "Leaderboard",
    fetchKeys: [],
    domain: "campus",
    sourceMode: "internal",
