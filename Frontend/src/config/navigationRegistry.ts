...
export const SUPPLEMENTAL_ROUTE_CATALOG: RouteCatalogEntry[] = [
  ...
  { route: "/learn/discover", label: "Discover", group: "Learning", domain: "lms", keywords: "browse search discover resources guides roadmaps pyq explore" },
  ...
  { route: "/learn/requests", label: "Request board", group: "Learning", domain: "lms", keywords: "request board fulfil community" },
