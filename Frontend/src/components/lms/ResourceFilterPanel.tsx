...
export default function ResourceFilterPanel({
  ...
  return (
    <section className="dashboard-card grid gap-3 p-4 md:grid-cols-4">
      <input
        className="rounded-xl border border-[color-mix(in_srgb,var(--comp-accent)_10%,transparent)] bg-[var(--comp-surface)] px-3 py-2 text-sm outline-none focus:border-[var(--info)]"
        placeholder="Search"
        value={filters.query || ""}
