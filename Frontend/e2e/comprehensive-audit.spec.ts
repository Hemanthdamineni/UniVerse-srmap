...
test.describe("comprehensive-site-audit", () => {
  test("run end-to-end crawl and generate audit report", async ({ page }) => {
    ...
    const queue = [
      ...
      "/resources/add",
      "/resources/guides",
      "/resources/guides/new",
      "/resources/roadmaps",
      "/resources/roadmaps/new",
      "/resources/question-bank",
      "/resources/requests",
      "/resources/me/bookmarks",
      "/resources/me/collections",
      "/resources/me/progress",
      "/resources/me/revision",
      "/resources/me/exam-feedback",
      "/career",
      "/career/jobs",
      "/career/internships",
      "/career/hackathons",
